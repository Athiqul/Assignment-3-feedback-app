    ...
    <div class="relative flex min-h-screen overflow-hidden bg-gray-50 py-6 sm:py-12">
        ...
        <div class="relative max-w-7xl mx-auto">
            <div class="flex justify-end">
                <span class="block text-gray-600 font-mono border border-gray-400 rounded-xl px-2 py-1">Your feedback form link: <strong>http://localhost/feedback/<?=$_SESSION['user']['feedback_token']?></strong></span>
            </div>
